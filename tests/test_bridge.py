...
def test_bridge_df_generates_valid_url():
    ...
    assert base64_data.endswith(
        "6tWSkksSSxOLVGyUqgGs4GM6GqlCiBlqKOgVAmklRKVanUUIGJGMLEkhJgxTCxZqTYWyM5LzE0FcUNSi0sUXNyUgEIlienFIIOVSvMyS8ACQDml2NpaAPBAIdGAAAAA"
    )
